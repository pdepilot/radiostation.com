document.addEventListener("DOMContentLoaded", function () {
  ...
  videoPlayers.forEach((player) => {
    player.addEventListener("click", function (e) {
      ...
      alert(
        `Video ${videoId} playback would start here in a full implementation`
      );
    });
  });
  ...
  const shareButtons = document.querySelectorAll(
    ".share-podcast-btn, #heroShareBtn"
  );
  ...
  sharePlatforms.forEach((platform) => {
    platform.addEventListener("click", function () {
      ...
      const title = encodeURIComponent(
        "Check out this amazing podcast on Darling FM!"
      );
      ...
      switch (platformName) {
        case "facebook":
          shareWindow = `https://www.facebook.com/sharer/sharer.html?u=${url}`;
          break;
        case "twitter":
  ...
  const podcasts = {
    1: {
      ...
      audioUrl:
        "https://open.spotify.com/episode/3PL9rQWegcS6onCjjH8ETY?si=qmRZe-P1TeWJKsLs7_1e9w&context=spotify%3Aplaylist%3A37i9dQZF1FgnTBfUlzkeKt",
      imageUrl:
        "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80",
    },
    2: {
  ...
  document
    .querySelectorAll(".play-podcast, .play-podcast-btn")
    .forEach((btn) => {
