    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="admin-dash.html" class="active"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
                ...
                <li><a href="admin-djs.html"><i class="fas fa-user"></i> <span>Feedback</span></a></li>
            ...
            card.addEventListener('click', function() {
              ...
              switch(action) {
                ...
                case 'go-live':
                  ...
                  window.location.href = 'admin-livestream.html';
                  break;
                case 'view-reports':
                  // Navigate to statistics page
                  window.location.href = 'admin-statistic.html';
                  break;
