...
document.addEventListener('DOMContentLoaded', function() {
    function addResetButton() {
        ...
        button.addEventListener('click', function(e) {
            ...
            if (confirm(`Are you sure you want to reset ${periodLabel} analytics data to 0? This action cannot be undone.`)) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        alert('Failed to reset analytics: ' + (data.message || 'Unknown error'));
