...
<head>
    ...
    <title>Darling FM - playlist</title>
        ...
        <div class="header-content">
          ...
          <nav class="desktop-nav">
            <ul>
              ...
              <li><a href="./playlist.php" class="active">Playlist</a></li>
    ...
    <div class="main-content">
      <div class="container">
        ...
        <div class="page-header">
          <h1>DARLING FM 109.7 PLAYLIST</h1>
          <p>
        ...
        <div class="music-library">
          <div class="library-header">
            ...
            <div class="library-count" id="track-count">6 tracks</div>
          </div>
          ...
          <div class="queue-list">
            <div class="queue-header">
              ...
              <div class="queue-actions">
                <button class="queue-action-btn" id="shuffle-queue-btn">
                  <i class="fas fa-random"></i> Shuffle
                </button>
                <button class="queue-action-btn" id="clear-queue-btn">
